...
START_TEST(standard_2) { assert_strncpy("Hello", 5, "Initial", "Initial", 15); }
END_TEST
...
START_TEST(border_1) { assert_strncpy("", 0, "", "", 5); }
END_TEST
...
START_TEST(irregular_3) { assert_strncpy("123456", 6, "abcdef", "abcdef", 6); }
END_TEST

START_TEST(irregular_4) { assert_strncpy("\0", 1, "", "", 5); }
END_TEST

Suite *test_strncpy(void) {
  Suite *s = suite_create("\033[47;30mstrncpy\033[0m");
