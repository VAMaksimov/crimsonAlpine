...
START_TEST(strcspn_first_decimal_match) { assert_strcspn("6", "67"); }
END_TEST
...
START_TEST(strcspn_first_character_match) { assert_strcspn("abc", "b"); }
END_TEST
...
Suite *test_strcspn(void) {
  ...
  tcase_add_test(tc, strcspn_first_decimal_match);
