...
START_TEST(strcspn_empty_string_first) { assert_strcspn("", "Hello, world!"); }
END_TEST

START_TEST(strcspn_empty_set_second) { assert_strcspn("Hello, world!", ""); }
END_TEST

START_TEST(strcspn_first_character_match) { assert_strcspn("6", "67"); }
END_TEST

START_TEST(strcspn_full_match) { assert_strcspn("69917020", "69917020"); }
END_TEST
...
START_TEST(strcspn_partial_first_match) { assert_strcspn("699", "69917020"); }
END_TEST

START_TEST(strcspn_partial_second_match) { assert_strcspn("69917020", "699"); }
END_TEST

START_TEST(strcspn_both_empty_strings) { assert_strcspn("", ""); }
END_TEST
...
START_TEST(strcspn_single_character_no_match) { assert_strcspn("b", "a"); }
END_TEST

START_TEST(strcspn_first_character_match2) { assert_strcspn("abc", "b"); }
END_TEST

START_TEST(strcspn_second_string_in_first) { assert_strcspn("abcdef", "def"); }
END_TEST

START_TEST(strcspn_repeated_characters) { assert_strcspn("aaaaa", "a"); }
END_TEST

START_TEST(strcspn_no_match_in_set) { assert_strcspn("aaaaa", "b"); }
END_TEST

START_TEST(strcspn_single_character_empty_set) { assert_strcspn("a", ""); }
END_TEST
...
Suite *test_strcspn(void) {
  ...
  tcase_add_test(tc, strcspn_first_character_match2);
