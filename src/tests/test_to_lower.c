...
START_TEST(standart_1) {
  assert_to_lower("HELLO, WORLD!", "hello, world!");
}
END_TEST
...
START_TEST(border_2) {
  assert_to_lower("already lower", "already lower");
}
END_TEST

START_TEST(border_3) {
  assert_to_lower(S21_NULL, S21_NULL);
}
END_TEST

START_TEST(irregular_1) {
  assert_to_lower("_?};!234", "_?};!234");
}
END_TEST

START_TEST(irregular_2) {
  assert_to_lower("123ABCdef", "123abcdef");
}
END_TEST

START_TEST(irregular_3) {
  assert_to_lower("!!!HELLO!!!", "!!!hello!!!");
}
END_TEST
