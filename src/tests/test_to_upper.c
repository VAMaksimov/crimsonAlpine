...
START_TEST(standart_1) {
  assert_to_upper("Hello, world!", "HELLO, WORLD!");
}
END_TEST
...
START_TEST(border_2) {
  assert_to_upper("ALREADY UPPER", "ALREADY UPPER");
}
END_TEST

START_TEST(border_3) {
  assert_to_upper(S21_NULL, S21_NULL);
}
END_TEST

START_TEST(irregular_1) {
  assert_to_upper("_?};!234", "_?};!234");
}
END_TEST

START_TEST(irregular_2) {
  assert_to_upper("123456", "123456");
}
END_TEST

START_TEST(irregular_3) {
  assert_to_upper("mixed CASE 123", "MIXED CASE 123");
}
END_TEST

START_TEST(irregular_4) {
  assert_to_upper("!!!Hello!!!", "!!!HELLO!!!");
}
END_TEST
