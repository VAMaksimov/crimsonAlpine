...
void assert_trim(const char *input, const char *trim_chars, const char *expected) {
...
START_TEST(standart_2) {
  assert_trim("!!!abcdefghij!?!", "!?", "abcdefghij");
}
END_TEST

START_TEST(standart_3) {
  assert_trim("abc", "333", "abc");
}
END_TEST
