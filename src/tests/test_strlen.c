...
START_TEST(standard_1) { assert_strlen("Hello, world!"); }
END_TEST
...
START_TEST(border_1) { assert_strlen(""); }
END_TEST

START_TEST(border_2) { assert_strlen("\0"); }
END_TEST

START_TEST(border_3) { assert_strlen("\t\t"); }
END_TEST

START_TEST(border_4) { assert_strlen("\n\n\n\n\n\n\n\n\nlololol\n\n\n\n\n"); }
END_TEST
...
START_TEST(irregular_3) { assert_strlen("wtf \0 wtf"); }
END_TEST
...
Suite *test_strlen(void) {
  Suite *s = suite_create("\033[47;30mstrlen\033[0m");
