...
void assert_insert(const char *s1, const char *s3, s21_size_t num, const char *expected) {
...
START_TEST(standart_1) {
  assert_insert("hello, world!", "hELLO, WORLD!", 7, "hello, hELLO, WORLD!world!");
}
END_TEST
...
START_TEST(standart_3) {
  assert_insert("abc", "333", 10, S21_NULL);
}
END_TEST
...
START_TEST(border_3) {
  assert_insert(S21_NULL, "", 0, S21_NULL);
}
END_TEST
...
START_TEST(irregular_1) {
  assert_insert("wtf", S21_NULL, 0, S21_NULL);
}
END_TEST

START_TEST(irregular_2) {
  assert_insert(S21_NULL, S21_NULL, 0, S21_NULL);
}
END_TEST

START_TEST(irregular_3) {
  assert_insert("", "", 7, S21_NULL);
}
END_TEST

START_TEST(irregular_4) {
  assert_insert("non-empty", "insert", 20, S21_NULL);
}
END_TEST
